...
/**
 *  * Clase Principal para manejo de alertas  * @see <br>
 *  * El constructor resive 3 parametros (mensaje, tipo_de_alerta,
 * icono_personalizado)  * <h1>El parámetro tipoDialog tiene las siguientes
 * opciones: JOptionPane</h1>
 *  *
...
public class MsgBox {
    ...
    public MsgBox(String msg, int tipoDialog, String iconPropio) {
        ...
        }else{ JOptionPane.showMessageDialog(p, msg, "Holas", tipoDialog);}
